...
<div name="droite" style="float:left;width:80%;">
	...
	<form name="formSaisieFrais" method="post" action="enregSaisieFrais.php">
		...
		<label class="titre">PERIODE D'ENGAGEMENT :</label>
			...
			<label style="float:left;">&nbsp;Ann�e (4 chiffres) : </label><input type="text" size="4" name="FRA_AN" class="zone" />
		...
		<label class="titre">Nuit�es :</label><input type="text" size="2" name="FRA_NUIT" class="zone" />
